class OrderItemModel {
  ...
  factory OrderItemModel.fromJson(Map<String, dynamic> json) {
    return OrderItemModel(
      ...
      expiryDate: json['expiryDate'] != null
          ...
          : null,
      fulfilledQuantity: json['fulfilledQuantity'] != null
          ? (json['fulfilledQuantity'] as num).toDouble()
          : null,
      backorderedQuantity: json['backorderedQuantity'] != null
          ? (json['backorderedQuantity'] as num).toDouble()
          : null,
  ...
  final double? backorderedQuantity;
  final String?
      fulfillmentStatus; // e.g., 'pending', 'fulfilled', 'backordered'
