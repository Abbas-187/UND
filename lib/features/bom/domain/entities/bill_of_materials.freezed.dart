...
mixin _$BillOfMaterials {
  ...
  /// Create a copy of BillOfMaterials
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $BillOfMaterialsCopyWith<BillOfMaterials> get copyWith =>
      _$BillOfMaterialsCopyWithImpl<BillOfMaterials>(
          this as BillOfMaterials, _$identity);

  /// Serializes this BillOfMaterials to a JSON map.
  ...
  @override
  String toString() {
    return 'BillOfMaterials(id: $id, bomCode: $bomCode, bomName: $bomName, productId: $productId, productCode: $productCode, productName: $productName, bomType: $bomType, version: $version, baseQuantity: $baseQuantity, baseUnit: $baseUnit, status: $status, items: $items, totalCost: $totalCost, laborCost: $laborCost, overheadCost: $overheadCost, setupCost: $setupCost, yieldPercentage: $yieldPercentage, description: $description, notes: $notes, approvedBy: $approvedBy, approvedAt: $approvedAt, effectiveFrom: $effectiveFrom, effectiveTo: $effectiveTo, productionInstructions: $productionInstructions, qualityRequirements: $qualityRequirements, packagingInstructions: $packagingInstructions, alternativeBomIds: $alternativeBomIds, parentBomId: $parentBomId, childBomIds: $childBomIds, createdAt: $createdAt, updatedAt: $updatedAt, createdBy: $createdBy, updatedBy: $updatedBy)';
  }
}

/// @nodoc
abstract mixin class $BillOfMaterialsCopyWith<$Res> {
  factory $BillOfMaterialsCopyWith(
          BillOfMaterials value, $Res Function(BillOfMaterials) _then) =
      _$BillOfMaterialsCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String bomCode,
...
/// @nodoc
class _$BillOfMaterialsCopyWithImpl<$Res>
    implements $BillOfMaterialsCopyWith<$Res> {
  _$BillOfMaterialsCopyWithImpl(this._self, this._then);

  final BillOfMaterials _self;
  final $Res Function(BillOfMaterials) _then;
...
/// @nodoc
@JsonSerializable()
class _BillOfMaterials extends BillOfMaterials {
  const _BillOfMaterials(
      {required this.id,
      ...
      : _items = items,
        ...
        super._();
  factory _BillOfMaterials.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BillOfMaterialsCopyWith<_BillOfMaterials> get copyWith =>
      __$BillOfMaterialsCopyWithImpl<_BillOfMaterials>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$BillOfMaterialsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$BillOfMaterialsCopyWith<$Res>
    implements $BillOfMaterialsCopyWith<$Res> {
  factory _$BillOfMaterialsCopyWith(
          _BillOfMaterials value, $Res Function(_BillOfMaterials) _then) =
      __$BillOfMaterialsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$BillOfMaterialsCopyWithImpl<$Res>
    implements _$BillOfMaterialsCopyWith<$Res> {
  __$BillOfMaterialsCopyWithImpl(this._self, this._then);

  final _BillOfMaterials _self;
  final $Res Function(_BillOfMaterials) _then;
