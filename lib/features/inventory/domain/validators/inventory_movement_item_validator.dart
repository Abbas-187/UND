...
class InventoryMovementItemValidator
    implements Validator<InventoryMovementItemModel> {
  const InventoryMovementItemValidator({this.isPerishable = false});

  /// Whether the item is perishable and requires full batch tracking
  final bool isPerishable;

  @override
  ValidationResult validate(InventoryMovementItemModel item) {
    final errors = <String>[];
