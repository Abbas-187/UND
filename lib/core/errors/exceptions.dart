...
class NetworkException extends AppException {
  NetworkException(String message, {super.data})
      : super(
          message: message,
...
class ApiException extends AppException {
  ApiException(String message, {int? statusCode, super.data})
      : super(
          message: message,
...
class DataParsingException extends AppException {
  DataParsingException(String message, {super.data})
      : super(
          message: message,
...
class ServiceException extends AppException {
  ServiceException(String message, {super.data})
      : super(
          message: message,
          type: AppExceptionType.unknown,
        );
...
class RequestTimeoutException extends AppException {
  RequestTimeoutException(String message, {super.data})
      : super(
          message: message,
