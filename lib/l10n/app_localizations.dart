...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      'autoGeneratedInventoryNote': 'Auto-generated inventory note',
      'createdFromInventoryNote':
          'Created from inventory note {productionOrderId}',
      'materialRequisitionReason':
          'Material requisition reason {requisitionId}',
      'materialRequisitionNotFound': 'Material requisition not found',
    },
    'ar': {
      ...
      'acknowledge': 'استلام',
      'autoGeneratedInventoryNote': 'ملاحظة المخزون التي تم إنشاؤها تلقائيًا',
      'createdFromInventoryNote':
          'تم الإنشاء من ملاحظة المخزون {productionOrderId}',
      'materialRequisitionReason': 'سبب طلب المواد {requisitionId}',
      'materialRequisitionNotFound': 'طلب المواد غير موجود',
    },
    'ur': {
      ...
      'noAlertsAtThisTime': 'لا توجد تنبيهات في الوقت الحالي.',
      'acknowledge': 'استلام',
      'autoGeneratedInventoryNote': 'خودکار طور پر تیار کردہ انوینٹری نوٹ',
      'createdFromInventoryNote':
          'انوینٹری نوٹ سے بنایا گیا {productionOrderId}',
      'materialRequisitionReason': 'مواد کی درخواست کی وجہ {requisitionId}',
      'materialRequisitionNotFound': 'مواد کی درخواست نہیں ملی',
    },
    'hi': {
      ...
      'autoGeneratedInventoryNote': 'स्वतः उत्पन्न इन्वेंटरी नोट',
      'createdFromInventoryNote':
          'इन्वेंटरी नोट से बनाया गया {productionOrderId}',
      'materialRequisitionReason': 'सामग्री अनुरोध कारण {requisitionId}',
      'materialRequisitionNotFound': 'सामग्री अनुरोध नहीं मिला',
    },
  };
  ...
  String get unit_each =>
      _localizedValues[locale.languageCode]?['unit_each'] ?? '';
  ...
  String get autoGeneratedInventoryNote =>
      _localizedValues[locale.languageCode]?['autoGeneratedInventoryNote'] ??
      '';
  String createdFromInventoryNote(String productionOrderId) =>
      (_localizedValues[locale.languageCode]?['createdFromInventoryNote'] ?? '')
          .replaceAll('{productionOrderId}', productionOrderId);
  String materialRequisitionReason(String requisitionId) =>
      (_localizedValues[locale.languageCode]?['materialRequisitionReason'] ??
              '')
          .replaceAll('{requisitionId}', requisitionId);
  String get materialRequisitionNotFound =>
      _localizedValues[locale.languageCode]?['materialRequisitionNotFound'] ??
      '';

  /// Export all localizations as ARB-compatible JSON strings for each language.
  static Map<String, String> exportToArb() {
    final Map<String, String> arbFiles = {};
    _localizedValues.forEach((lang, values) {
      final arb = <String, dynamic>{
        '@@locale': lang,
        ...values,
      };
      arbFiles[lang] = _arbJsonEncode(arb);
    });
    return arbFiles;
  }

  /// Helper to pretty-print JSON for ARB files.
  static String _arbJsonEncode(Map<String, dynamic> map) {
